...
export default function TaxAndCostSection({ data, onChange }: Props) {
  return (
    <fieldset>
      ...
      <NumberInput label="Other Home Costs (annual)" value={data.other_home_costs_annual} onChange={(v) => onChange("other_home_costs_annual", v)} suffix="$/yr" />
    </fieldset>
  );
}
